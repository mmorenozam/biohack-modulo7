...
::: {.title data-id="title"}
[Ejercicios 7.1](https://mmorenozam.github.io/biohack_progR/ejercicios_m7.html#ejercicios-7.1){target="_blank"}
:::
...
## Consideraciones antes de implementar ACP {.smaller}
...
## ACP en R {.smaller visibility="uncounted"}
...
```{r echo=F, eval=T, error=T, fig.width=6, fig.align='center'}
library(ggplot2)
library(ggbiplot)
...
## ACP en R {.smaller visibility="uncounted" .scrollable}
...
::: {.title data-id="title"}
[Ejercicios 7.2](https://mmorenozam.github.io/biohack_progR/ejercicios_m7.html#ejercicios-7.2){target="_blank"}
:::

:::{.timer #Timer2 seconds=600 starton=interaction}
:::

:::
:::

![](images/timo-volz-ZlFKIG6dApg-unsplash.jpg){.image-left}
...
Foto en Ejercicio 7.2 por <a href="https://unsplash.com/@magict1911?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Timo Volz</a> en <a href="https://unsplash.com/photos/orange-cat-stretching-on-white-surface-ZlFKIG6dApg?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
